...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT INTO `user` (`first_name`,`last_name`,`email`,`phone_no`,`address`,`city`,`password`,`NIC`,`early_experience`,`have_vehicle`) 
  VALUES('$first_name','$last_name','$email','$phone_no','$address','$city','$encPass','$id_no','$experience','$vehicle')";
